...
/*
Plenty of unneeded code left over from default login activity.
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Attempt to see if already known user, then auto sign in to dashboard
         *
         */

        /**
         * This is commented out until i learn how to sign out
         */
    /**
        if (firebaseAuth.getCurrentUser() != null) {
            startActivity(new Intent(LoginActivity.this, PostList.class));
    ...
    **/
    ...
    /**
     * Attempt to register user if they click register (not implemented yet)
     * Look into .trim() and what its used for
     */
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
        //Here is where I need to check if login has failed, cant be within login!
            /**
             * BUGS: WHEN LOGIN FAILS, STUCK ON LOADING NEED TO RESET HERE
             **/
